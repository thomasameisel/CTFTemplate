...
db.run('CREATE TABLE IF NOT EXISTS users (username TEXT PRIMARY KEY, hash TEXT, is_admin BOOLEAN, competing BOOLEAN)');
db.run('CREATE TABLE IF NOT EXISTS completed (username TEXT, challenge_id INT, time_completed INT, PRIMARY KEY(username, challenge_id))');
db.run('CREATE TABLE IF NOT EXISTS attempts (username TEXT, challenge_id INT, time_completed INT, attempt TEXT, PRIMARY KEY(username, challenge_id, time_completed))');
